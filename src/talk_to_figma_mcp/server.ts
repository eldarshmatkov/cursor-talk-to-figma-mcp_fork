...
server.tool(
    ...
    "Get detailed information about a specific node in Figma",
    {
        ...
        filterEmpty: z.boolean().optional().describe("Whether to filter out empty arrays and objects (default: true)")
    },
    async ({ nodeId, filterEmpty = true }) => {
        try {
            const result = await sendCommandToFigma('get_node_info', { nodeId, filterEmpty });
            return {
                content: [
                    {
                        type: "text",
